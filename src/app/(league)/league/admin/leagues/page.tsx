...
import { Trophy, Plus, ArrowLeft, Users, ScrollText, Calendar, Target, Dices, Loader2 } from "lucide-react";
...
export default function AdminLeagues() {
    ...
    useEffect(() => {
        ...
        const fetchDetails = async () => {
            ...
            // Traer todos los jugadores globales aprobados
            ...
            // Traer logros habilitados en esta liga
    ...
    const handleCreateMatchday = async (e: React.FormEvent) => {
        ...
        const { data } = await supabase
            ...
            .insert({ league_id: selectedLeague.id, title: newMatchdayTitle.trim() })
            .select()
            .single();
